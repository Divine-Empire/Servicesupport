...
//   { name: "Site Visit By Sinior", href: "/sitevisit", icon: Wrench },
//   {
//     name: "Site Visit By Accountant",
...
//       <div className="w-64 bg-gradient-to-b from-indigo-900 via-purple-900 to-blue-900 text-white flex-shrink-0 h-screen overflow-y-auto z-50 relative">
...
//           <div className="px-4 py-4 overflow-y-auto scrollbar-hide">
...
//           <div className="mt-auto p-4 border-t border-purple-700/50 bg-gradient-to-r from-blue-900/80 to-indigo-900/80 backdrop-blur-sm">
//             <button
//               onClick={() => {
//                 handleLogout();
//                 onClose?.();
