...
export default function AccountablityApproval() {
  ...
  const handleSubmit = async (e) => {
    ...
    let screenShortfileUrls = "";

    // Handle all file uploads

    if (formData.screenShort) {
      const uploadResult = await uploadImageToDrive(formData.screenShort);
      if (!uploadResult.success) {
        throw new Error(
          uploadResult.error || "Failed to upload calibration copy"
        );
      }
      screenShortfileUrls = uploadResult.fileUrl;
    }
      ...
      const response = await fetch(sheet_url, {
        ...
        body: new URLSearchParams({
          ...
          columnData: JSON.stringify({
            ...
            AX: screenShortfileUrls || "",
            AY: formData.senderName || "",
          }),
        }).toString(),
      });
        ...
        setHistoryData((prev) => [
          {
            ...
            screenShort: screenShortfileUrls || "",
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              <Input
                type="file"
                onChange={(e) =>
                  handleInputChange("screenShort", e.target.files[0] || "")
                }
