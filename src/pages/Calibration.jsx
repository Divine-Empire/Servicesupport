          ...
          filteredPendingData.map((ticket, ind) => (
            <Card key={ind} className={`${ind % 2 === 0 ? "bg-blue-50/50" : "bg-white"} border-l-4 border-l-indigo-500`}>
              <CardContent className="p-4 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  <div>
                    <p className="text-gray-500 font-medium">Service Invoice</p>
                    <p className="text-blue-900">{ticket.invoiceNoSERVICE || "N/A"}</p>
                  </div>
                  <div>
                    <p className="text-gray-500 font-medium">NABL Invoice</p>
                    <p className="text-blue-900">{ticket.nablInvoice || "N/A"}</p>
                  </div>
                </div>
                ...
                {/* Quotation PDF */}
                <div>
                  <p className="text-gray-500 font-medium text-sm">Quotation PDF</p>
                  {ticket.quotationPdfLink ? (
                    <a
                      href={ticket.quotationPdfLink}
                      target="_blank"
          ...
          filteredHistoryData.map((ticket, ind) => (
            <Card key={ind} className={`${ind % 2 === 0 ? "bg-blue-50/50" : "bg-white"} border-l-4 border-l-indigo-500`}>
              <CardContent className="p-4 space-y-3">
                ...
                {/* Calibration Upload */}
                <div>
                  <p className="text-gray-500 font-medium text-sm">Calibration Certificate</p>
                  {ticket.calibrationUploadFile ? (
                    <a
                      href={ticket.calibrationUploadFile}
                      target="_blank"
