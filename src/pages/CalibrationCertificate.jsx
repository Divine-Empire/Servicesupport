      ...
      const response = await fetch(sheet_url, {
        ...
        body: new URLSearchParams({
          ...
          columnData: JSON.stringify({
            BA: currentDateTime,
            BC: formData.certificateTypeName || "",
            BD: formData.numberOfCertificatesDocuments || "",
            BE: formData.fullDestinationAddress || "",

            BF: formData.dateOfDispatch || "",
            BG: formData.courierCompanyName || "",
            BH: formData.courierTrackingNumber || "",
            BI: formData.expectedDeliveryDate || "",
            BJ: attachmentfileUrls || "",
          }),
        }).toString(),
      });
    ...
    <div className="space-y-6">
      ...
      >
        ...
        >
          ...
          {/* <div className="space-y-1">
            <Label className="text-sm font-medium text-gray-700">
              Certificate Update Person Name{" "}
              <span className="text-red-500">*</span>
            </Label>
            <Select
              onValueChange={(value) =>
