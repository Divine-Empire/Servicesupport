...
export default function ClientDetails() {
  ...
  //         column: "G", // Column G in Master sheet
  //         value: value,
  //       }),
  //     });
  ...
  //       toast.success("Custom machine name saved successfully");
  //     }
  //   } catch (error) {
  //     console.error("Error saving custom machine:", error);
  //     toast.error("Failed to save custom machine name");
  //   }
  // };
                  ...
                  >
                    ...
                    <SelectContent className="bg-white border border-gray-300 rounded-md shadow-lg">
                      ...
                      masterData[0]["Source of enquiry"] ? (
                        masterData[0]["Source of enquiry"].map((item, ind) => (
                          <SelectItem
                            key={ind}
                            value={item}
                      ...
                      <div className="relative">
                        <Select
                          onValueChange={(value) => {
                            if (value === "custom") {
                              ...
                              const newSelected = [...selectedMachines, value];
                        ...
                        >
                          ...
                          >
                            ...
                            {masterData[0]?.["Machine Name"]?.map((option) => (
                              <SelectItem
                                key={option}
                                value={option}
