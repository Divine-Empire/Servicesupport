  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const rowData = [
        ...
        formData.followupremarks || "", // Machine Name
      ];
        ...
        setFollowUpData((prevHistory) => [
          {
            ...
            remarks: formData.followupremarks || "", // Add remarks
          },
          ...prevHistory,
        ]);
        ...
        <>
          ...
          <div>
            ...
            >
              ...
              <SelectContent className="bg-white border border-gray-300 rounded-md shadow-lg">
                {masterData.length > 0 && masterData[0]["Share through"] ? (
                  masterData[0]["Share through"].map(
                    (item, ind) =>
                      item && ( // Only render if item is not empty
                        <SelectItem
                          key={ind}
          ...
          <div>
            ...
            <Textarea
              ...
              onChange={(e) =>
                handleInputChange("followupremarks", e.target.value)
              }
    ...
    <div className="space-y-2">
                      ...
                      {followUpData.length === 0 ? (
                        ...
                        followUpData.reverse().map((ticket, ind) => (
                          ...
                          >
                            ...
                            <td className="px-4 py-3 text-blue-900">
                              {formatDate(ticket.acceptance_via) || "N/A"}
                            </td>
      ...
      >
        ...
        >
          ...
          {/* Editable fields */}
          <div>
            <Label>Approval Attachments </Label>
            <Input
              type="file"
              placeholder="Approval Attachments"
              onChange={(e) =>
          ...
          <div>
            <Label>Acceptance Attachments </Label>
            <Input
              type="file"
              placeholder="Acceptance Attachments"
              onChange={(e) =>
