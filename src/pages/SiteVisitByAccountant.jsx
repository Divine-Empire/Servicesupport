            ...
            >
              ...
              {!isCancelled && (
                <>
                  ...
                  <div className="space-y-1">
                    <Label className="text-gray-600 font-medium">Request Amount</Label>
                    <Input
                  ...
                  <div className="space-y-1">
                    <Label className="text-gray-600 font-medium">Approved Amount</Label>
                    <Input
                    ...
                    >
                      ...
                      <SelectContent className="bg-white border border-gray-300 rounded-md shadow-lg">
                        ...
                        masterData[0]["Expence Approval By Accounts"] ? (
                          masterData[0]["Expence Approval By Accounts"].map((item, ind) => (
                            <SelectItem
                              key={ind}
                              value={item || ""}
