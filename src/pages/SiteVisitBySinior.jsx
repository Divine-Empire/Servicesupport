      ...
      const response = await fetch(sheet_url, {
        ...
        body: new URLSearchParams({
          ...
          columnData: JSON.stringify({
            ...
            // CA: formData.lastBalance || "",
            // CB: formData.payRightNow || "",
            // CC: formData.billNo || "",
            // CD: fileUrl || "",
            // CE: formData.remarks || "",
          }),
    ...
    <div className="space-y-6">
      ...
      {/* <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="pending">
          <Card>
            <CardHeader>
              <CardTitle>Pending Site Visits</CardTitle>
            </CardHeader>
            <CardContent>
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead>Enquiry Receiver Name</TableHead>
                      <TableHead>Warranty Check</TableHead>
                      <TableHead>Machine Name</TableHead>
                      <TableHead>Enquiry Type</TableHead>
                      <TableHead>Engineer Assign</TableHead>
                      <TableHead>Travel Date</TableHead>
                      <TableHead>Return Date</TableHead>
                      <TableHead>Destination</TableHead>
                      <TableHead>Purpose of Travel</TableHead>
                    ...
                    {filteredPendingData.length === 0 ? (
                        ...
                        >
                          {fetchLoading ? (
                           <div className="flex justify-center items-center">
                            ...
                            <h1>No pending site visits found.</h1>
                          )}
                        </TableCell>
                      </TableRow>
                    ) : (
                      filteredPendingData.map((ticket, ind) => (
                        <TableRow key={ind}>
                          ...
                          <TableCell>{ticket.warrantyCheck}</TableCell>
                          <TableCell>{ticket.machineName || "N/A"}</TableCell>
                          <TableCell>{ticket.enquiryType}</TableCell>
                          <TableCell>
        ...
        <TabsContent value="history">
          <Card>
            <CardHeader>
              <CardTitle>Site Visit History</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="overflow-x-auto">
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead>Approval Name</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    {filteredHistoryData.length === 0 ? (
                        ...
                        >
                          {fetchLoading ? (
                           <div className="flex justify-center items-center">
                            ...
                            <h1>No site visit history found.</h1>
                          )}
                        </TableCell>
                      </TableRow>
                    ) : (
                      filteredHistoryData.map((ticket, ind) => (
                        <TableRow key={ind}>
                          ...
                          <TableCell>{ticket.nameDropdown || "N/A"}</TableCell>
                        </TableRow>
                      ))
                    )}
                  </TableBody>
      ...
      >
        ...
        Site Visit Details
            ...
            >
              ...
              {/* Editable fields */}
              {/* <div className="space-y-1">
                <Label className="text-gray-600 font-medium">Approval *</Label>
                <Select
                  onValueChange={(value) =>
                    handleInputChange("approval", value)
                  }
                >
                  <SelectTrigger
                  ...
                  <SelectContent className="bg-white border border-gray-300 rounded-md shadow-lg">
                    {masterData.length > 0 && masterData[0]["APPROVAL"] ? (
                      masterData[0]["APPROVAL"].map((item, ind) => (
                        <SelectItem
                          key={ind}
                          value={item || "N/A"}
