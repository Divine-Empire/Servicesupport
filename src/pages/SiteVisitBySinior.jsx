            ...
            <Card key={ind} className={`${ind % 2 === 0 ? "bg-blue-50/50" : "bg-white"} border-l-4 border-l-blue-500`}>
              <CardContent className="p-4 space-y-3">
                ...
                <div>
                  ...
                  <p className="text-blue-900">{ticket.destinationInput || "N/A"}</p>
                </div>

                {/* Purpose of Travel */}
                <div>
                  <p className="text-gray-500 font-medium text-sm">Purpose of Travel</p>
                  <p className="text-blue-900 line-clamp-3">{ticket.purposeOfTravel || "N/A"}</p>
                </div>

                {/* Amount */}
                <div>
                  <p className="text-gray-500 font-medium text-sm">Amount</p>
                  <p className="text-blue-900 font-semibold text-lg">₹{ticket.amount || "0"}</p>
                </div>
              </CardContent>
            </Card>
          ))
          ...
          filteredHistoryData.map((ticket, ind) => (
            <Card key={ind} className={`${ind % 2 === 0 ? "bg-blue-50/50" : "bg-white"} border-l-4 border-l-blue-500`}>
              <CardContent className="p-4 space-y-3">
                ...
                {/* Engineer */}
                <div>
                  <p className="text-gray-500 font-medium text-sm">Engineer</p>
                  <p className="text-blue-900">{ticket.engineerAssign || "N/A"}</p>
                </div>
