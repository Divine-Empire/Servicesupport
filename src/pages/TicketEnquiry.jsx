...
//         // Find the row with actual headers (look for "Timestamp" in first column)
...
//             // Skip empty headers and clean up the data
//             if (header) {
//               ticket[header] = row[index] || "";
//             }
//           });
//           // Store Column A data for date display
...
//         // storage.setTickets(formattedTickets);
//       } else {
//         toast({
//           title: "error",
...
//         // Extract Column A data (categories) - skip header row
...
//         // Keep your existing master data processing for other purposes
...
//         ColumnAData: formatDateTime(new Date()), // Store Column A data
//       };
...
//                         className="bg-white border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
//                       >
//                         <SelectValue placeholder="Select category" />
//                       </SelectTrigger>
//                       <SelectContent
//                         className="bg-white border border-gray-200 shadow-lg rounded-md z-[60] max-h-[200px] overflow-y-auto"
//                         position="popper"
//                         sideOffset={4}
//                       >
//                         {categories.length > 0 ? (
...
//                               key={index}
//                               value={category}
//                               className="hover:bg-gray-100 focus:bg-gray-100 cursor-pointer px-3 py-2 text-sm"
//                             >
//                               {category}
//                             </SelectItem>
//                           ))
...
//                       </SelectTrigger>
//                       <SelectContent
//                         className="bg-white border border-gray-200 shadow-lg rounded-md z-[60]"
//                         position="popper"
//                         sideOffset={4}
//                       >
//                         <SelectItem
...
//                       <TableCell>{ticket["Phone Number"]}</TableCell>
//                       <TableCell>{ticket["Email Address"]}</TableCell>
