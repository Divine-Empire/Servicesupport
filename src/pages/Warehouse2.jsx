    ...
    try {
      ...
      if (json.success && Array.isArray(json.data)) {
        ...
        const allData = json.data.slice(6).map((row, index) => ({
          ...
          planned13: row[19], // REMARK
          actual13: row[20], // REMARK
          delay13: row[21], // REMARK
        }));
    ...
    <div className="space-y-6">
      ...
      {/* <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="pending">
          <Card>
            <CardHeader>
              <CardTitle>Pending Warehouse Entries</CardTitle>
            </CardHeader>
            <CardContent>
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead>Quotation Pdf Link</TableHead>
                      <TableHead>Basic Amount</TableHead>
                      <TableHead>Total Amount with Tax</TableHead>
                    ...
                    {filteredPendingData.length === 0 ? (
                      <TableRow>
                        ...
                        >
                          {fetchLoading ? (
                            ...
                            <h1>No pending warehouse entries found.</h1>
                          )}
                        </TableCell>
                      </TableRow>
                    ) : (
                      filteredPendingData.map((ticket, ind) => (
                        <TableRow key={ind}>
                          ...
                          <TableCell>{ticket.quotationNo}</TableCell>
                          ...
                          <TableCell>₹{ticket.basicAmount || "0"}</TableCell>
                          <TableCell>
                            ₹{ticket.totalAmountWithTex || "0"}
                          </TableCell>
                          <TableCell>{ticket.billNo || "0"}</TableCell>
                          <TableCell>
                            {ticket.billFile ? (
                              <a
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead>Transport Person</TableHead>
                    ...
                    {filteredHistoryData.length === 0 ? (
                      <TableRow>
                        ...
                        >
                          {fetchLoading ? (
                            ...
                            <h1>No warehouse history found.</h1>
                          )}
                        </TableCell>
                      </TableRow>
                    ) : (
                      filteredHistoryData.map((ticket, ind) => (
                        <TableRow key={ind}>
                          ...
                          <TableCell>{ticket.quotationNo || "N/A"}</TableCell>
                          <TableCell>{ticket.clientName}</TableCell>
                          <TableCell>{ticket.entryNo || "N/A"}</TableCell>
                          <TableCell>
                            {ticket.transportCourierPersonName || "N/A"}
                          </TableCell>
                          <TableCell>{ticket.contactNumber || "N/A"}</TableCell>
                          <TableCell>{ticket.destination || "N/A"}</TableCell>
                          <TableCell>
                            {ticket.transportLeadDays || "N/A"} days
                          </TableCell>
                        </TableRow>
                      ))
                    )}
        ...
        >
          ...
          <div className="space-y-1">
            ...
            <Input
              ...
              onChange={(e) =>
                handleInputChange("transportCourierPersonName", e.target.value)
              }
              className="border-gray-300 focus:border-blue-500 focus:ring-blue-500"
